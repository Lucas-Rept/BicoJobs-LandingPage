...
let navHidder = document.getElementById("navHidder");
let mobileNavContainer = document.getElementById("mobileNavContainer");
let mobileNav = document.getElementsByClassName("mobile-nav")[0];
navTrigger.addEventListener("click", showNav);
navHidder.addEventListener("click", hideNav);

function showNav(){
    mobileNavContainer.classList.toggle("mobile-nav-show");
    setTimeout(() => {
        mobileNav.classList.toggle("animatedNav");
    }, 100);
}
